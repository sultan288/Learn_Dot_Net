<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/BlankPages.Master" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="RealProjectH3.Authen.login" %>
                    ...
                    <div class="card mt-1">
                        <div class="card-body ">
                            ...
                            <div class="input-group flex-nowrap mt-4 justify-content-end">
                                ...
                                <asp:Button ID="btnLogin" runat="server" CssClass="btn btn-success form-control" Text="Login" OnClick="btnLogin_Click" />

                            </div>
                            <div class="login_links mt-3">
                                <a href="#" class="">Forgot Password</a>
                                <a href="regirter.aspx" class="float-right">Register</a>
                            </div>
                        </div>
                    </div>
                </div>
